...
subplot(2,1,2)
semilogy(t2,abs((error1))./abs((y1)),'k', 'Linewidth', 1.5); hold on
semilogy(t2,abs((error1_))./abs((y1)),'k:', 'Linewidth', 1.5);
semilogy(t2,abs((error2))./abs((y1)),'--', 'Linewidth', 1.5, 'Color',[0.8500 0.3250 0.0980]);
ylim([1e-11,1e-1])
xlabel('time [s]','fontsize',20,'interpreter','latex')
ylabel('$|y(t)-y_r(t)|/|y(t)|$','fontsize',20, 'interpreter','latex')
legend('conformalBT','CIRKA','BT','fontsize',20, 'interpreter','latex', 'Location', 'northeast')