function [Ar,Br,Cr,sigma,converged] = conformalIRKA(A, B, C, r, phi, init, max_iters)
    % Implements the Conformal Iterative Rational Krylov Algorithm (IRKA) for MIMO systems
    %
    % Inputs:
